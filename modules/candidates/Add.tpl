...
include_once 'function.find_date.php';
                ...
                foreach ($fileInfo as $row) {
                    ...
                    // echo $part.'<br><br>';
                        ...
                        if (strpos($part, '@') || strpos($part, 'mail')) {
                            $pattern = '/[a-z0-9_.\s\-\+]+@[a-z0-9\-]+\.([a-z]{2,3})(?:\.[a-z]{2})?/i';
                        ...
                        if (isset($records['email'])) {
                            ...
                            // $string = "you gotta give the go kart a try";
                              // preg_match_all("go/","hello go word",$rec);
                             preg_match("/(\w+\s*\w+\s*\w+)\s/",$resumeText, $mat);
                           
                             $string = $mat[0];

                           $str_arr = preg_split ("/\s|\.|:/", $string); 

                           if($str_arr[0] == 'RESUME' || $str_arr[0] =='Resume'||$str_arr[0] =='resume'||$str_arr[0] =='Curriculumvitae'||$str_arr[0] =='CURRICULUMVITAE'||$str_arr[0] =='CurriculumVitae'||$str_arr[0] =='curriculum vitae'||$str_arr[0] =='Curriculum vitae'||$str_arr[0] =='CURRICULUM VITAE'||$str_arr[0] =='Curriculum Vitae') 
                           {
                           $records['fname'][] = $str_arr[1];
                           $records['lname'][] = $str_arr[2];
                       }
                       else
                       {
                        $records['fname'][] = $str_arr[0];
                        $records['lname'][] = $str_arr[1];
                       }
                        }
                ...
                <table class="editTable">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            ...
                            <input type="text" tabindex="1" name="firstName" id="firstName" class="inputbox" style="width: 150px" value="<?php 
                            if (isset($records['fname'])) { foreach ($records['fname'] as $value) {
                                                        echo $value; }}?>" />&nbsp;*
                        </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td valign="middle" align="right" colspan="2">
                                            ...
                                            <input type="file" id="documentFile" name="offer-main[]" multiple id="offer-main" onchange="documentFileChange();" size="<?php if ($this->isModal): ?>20<?php else: ?>40<?php endif; ?>" />
                                            <input type="button" id="documentLoad" onclick="loadDocumentFileContents()"  value="Upload" disabled />
                                            &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="right" valign="top" nowrap="nowrap" style="font-size: 11px;">
                                                            <a href="javascript:void(0);" onclick="$('#offer-main').click()" >(remove)</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <?php endif; ?>
                                            <textarea class="inputbox" tabindex="90" name="documentText" id="" rows="5" cols="40" onmousemove="documentCheck();"
                                             onchange="documentCheck();" onmousedown="documentCheck();" onkeypress="documentCheck();" 
                                             style="width: <?php if ($this->isModal): ?>320<?php else: ?>500<?php endif; ?>px; 
                                             height: 210px; padding: 3px;"><?php if(isset($records['text'])){
                                                 echo $records['text']; }?></textarea>
                                            <br/>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" tabindex="2" name="lastName" id="lastName" class="inputbox" style="width: 150px" value="<?php 
                            if (isset($records['lname'])) { foreach ($records['lname'] as $value) {
                                    echo $value; }}?>" />&nbsp;*
                        </td>
                    </tr> 
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" tabindex="3" name="email1" id="email1" class="inputbox" style="width: 150px" value="<?php 
                            if (isset($records['email'])) { foreach ($records['email'] as $value) {
                                                        echo $value; }}?>" onchange="checkEmailAlreadyInSystem(this.value);" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" tabindex="7" name="phoneCell" id="phoneCell" class="inputbox" style="width: 150px;" value="<?php if (isset($records['mobile'])) {
                                 foreach ($records['mobile'] as $value) { echo $value; }}
